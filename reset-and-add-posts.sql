-- Clear existing blog posts and insert all 12 posts from static blog
...
-- Now insert all 12 blog posts
INSERT INTO blog_posts (id, title, excerpt, content, date, read_time, category, slug) VALUES
(1, 
...
'2026-04-20', '6 min read', 'Productivity', 'act-on-what-matters'),
...
'2026-04-18', '7 min read', 'Systems', 'systems-beat-goals'),
...
'2026-04-16', '7 min read', 'Coaching', 'personal-coach-always'),

(4,
'Try It Free. Love the Results.',
'You may hate our system at first. But you''ll love the results. Why we offer a generous free tier.',
...
'2026-04-14', '5 min read', 'Getting Started', 'results-over-comfort'),

(5,
'AI That Assists, Not Replaces',
'In the AI craze, we believe differently. AI is "Assisted Intelligence"—not something that replaces your thinking.',
...
'2026-04-10', '6 min read', 'AI Philosophy', 'assisted-intelligence'),

(6,
'Clarity, Not Chaos or Confusion',
'Still trying to sort through todo backlogs? Overwhelmed? Stop organizing. Get clarity and execute what truly matters.',
...
'2026-03-28', '6 min read', 'Mental Clarity', 'clarity-not-chaos'),

(7,
'Like to Cross Tasks? Then Play Tic-Tac-Toe.',
'Crossing off tasks feels good. But it''s not the same as building productivity momentum. Learn the difference.',
...
'2026-03-22', '7 min read', 'Habit Building', 'tic-tac-toe-vs-system'),

(8,
'Systems Build Resilience to Absorb Failures',
'Worried about single points of failure? A system adapts. A todo list breaks. Build resilience with OT².',
...
'2026-04-08', '6 min read', 'Resilience', 'systems-resilience'),

(9,
'Action & Results Over Thinking & Procrastination',
'Tired of overthinking? OT² nudges you from analysis paralysis into action. Stop thinking. Start doing.',
...
<ol>
  ...
  <li><strong>Reflect:</strong> What did you learn? What would I do differently?</li>
</ol>
...
<p>That''s OT².</p>',
'2026-04-06', '5 min read', 'Action & Execution', 'action-over-thinking'),

(10,
'Works With GTD, PARA, CORE—Your Favorite System',
'Use GTD, PARA, CORE, or any productivity system. OT² is the app that supports them all. Give it a try.',
...
'2026-04-04', '6 min read', 'Systems Integration', 'systems-agnostic'),

(11,
'Commitment is Sacred—Be the Badass Who Delivers',
'Commit to deliver and deliver to your commitments. No excuses. Time is of the essence. OT² keeps you accountable.',
...
'2026-04-02', '6 min read', 'Commitment & Accountability', 'commitment-is-sacred'),

(12,
'Be Biased Towards Action—Your Moral Compass is Your Guide',
'If it''s allowed by your values, do it. Think with the results of your action. You''ll be more objective and more intuitive next time.',
...
'2026-03-31', '6 min read', 'Action & Intuition', 'bias-towards-action-moral-compass');
